        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-12">
          ...
          <div>
            ...
            <div class="space-y-2 text-[14px] text-dim">
              ...
              <p class="pt-1 text-charcoal/70">${t('openingHours.nightWeekendNote')} <a class="font-medium text-blueberry hover:text-blueberry-hover transition-colors whitespace-nowrap" href="tel:${PHONE_DIGITS}">${CONTACT_PHONE}</a></p>
            </div>
          </div>
        </div>
