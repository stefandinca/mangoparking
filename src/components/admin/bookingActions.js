...
// Pure time/money math (deadline, overstay, per-credit rate, date display)
// lives in utils/bookingTime.js so it's unit-testable — re-exported here
// because every admin page historically imports these from this module.
export { fmtDateTime, pickupDeadlineMs, perCreditPrice, overstayInfo } from '../../utils/bookingTime.js';
import { fmtDateTime, overstayInfo } from '../../utils/bookingTime.js';
