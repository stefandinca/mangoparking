  ...
  const page = html`<div>
    ...
    <section class="pt-32 pb-20 relative overflow-hidden">
      ...
      <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <a href="${localePath('/booking')}" class="inline-block bg-blueberry hover:bg-blueberry-hover text-white font-semibold text-[16px] px-10 py-4 rounded-2xl transition-colors shadow-md">${t('commuterPage.cta')}</a>
      </div>
    </section>
