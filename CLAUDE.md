...
- **Invoicing**: SmartBill — billing data (PF/PJ, CUI via ANAF lookup) is captured at checkout; API integration is **not wired yet** (planned). See [documentation/roadmap/v.1.2_smartbill.md](documentation/roadmap/v.1.2_smartbill.md)
